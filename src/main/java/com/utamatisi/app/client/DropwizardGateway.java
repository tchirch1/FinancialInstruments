...
import com.utamatisi.app.models.domain.*;
...
public class DropwizardGateway extends Application<DropwizardConfiguration> {
    ...
    private final HibernateBundle<DropwizardConfiguration> hibernateBundle =
            new HibernateBundle<DropwizardConfiguration>(Person.class, Account.class, Todo.class, Stock.class, BusinessDateMilestonedImpl.class) {
                @Override
