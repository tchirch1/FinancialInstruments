...
dialogModule.provider("$dialog", function () {
    ...
    //
    //      var com.utamatisi.app = angular.module('App', ['ui.bootstrap.dialog'], function($dialogProvider){
 ...
 */
    .provider('$tooltip', function () {
         ...
         * application.
         *
         *   var com.utamatisi.app = angular.module( 'App', ['ui.bootstrap.tooltip'], function( $tooltipProvider ) {
